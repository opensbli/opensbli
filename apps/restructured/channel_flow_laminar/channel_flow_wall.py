...
u0 = "Eq(GridVariable(u0), 45*(1-(x1-1)**2))"
u1 = "Eq(GridVariable(u1), 0)"
u2 = "Eq(GridVariable(u2), 0)"
p = "Eq(GridVariable(p), (1.0*(1.0+0.01944*(1-(x1-1)**4)))/(gama*Minf*Minf))"
r = "Eq(GridVariable(r), gama*Minf*Minf*p/(1.0+0.01944*(1-(x1-1)**4)))"
...
eqns = [x0, x1, x2, x0l, x1l, x2l, u0, u1, u2, p, r, rho, rhou0, rhou1, rhou2, rhoE]
